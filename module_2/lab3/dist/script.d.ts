...
declare class VehicleImplementation implements Vehicle {
    private _brand;
    private _model;
    private _year;
    private _vin;
...
declare const owner: VehicleOwner;
declare const car: VehicleImplementation;
...
declare class CarImplementation extends VehicleImplementation implements Car {
    private _bodyType;
    private _carClass;
...
declare class MotorbikeImplementation extends VehicleImplementation implements Motorbike {
    private _frameType;
    private _isSport;
...
declare const motorbike: MotorbikeImplementation;
...
declare const car1: CarImplementation;
declare const car2: CarImplementation;
declare const carStorage: VehicleStorageImpl<Car>;
declare const motorbikeStorage: VehicleStorageImpl<Motorbike>;
